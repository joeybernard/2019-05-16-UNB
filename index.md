...
venue: "Harriet Irving Library - UNB"        # brief name of host site without address (e.g., "Euphoric State University")
address: "HIL Learning Lab (Room 112), 5 MacAulay Lane, Fredericton, NB, E3B 5H5"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "45.946020,-66.641270"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Joey Bernard"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Serguei Vassiliev"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["joey.bernard@unb.ca"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: "https://pad.carpentries.org/2019-05-16-unb"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
